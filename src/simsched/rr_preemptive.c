...
} processdata = { 0, NULL, 0, NULL, NULL };
...
*/
void processer_rr_preemptive_init(workload_tt workload, array_tt cores, int *g_i)
{
    /* Sanity check. */
            ...
            */
            ...
            while ( !queue_empty(core_get_tsks(c)) )
            {
                ...
                */
                ...
                int amount_processed = (task_work_left(ts) > processdata.quantum) ? processdata.quantum : task_work_left(ts);
